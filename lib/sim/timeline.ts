...
export const SCRIPT: ScriptedEvent[] = [
  ...
  { t: 49, module: "flujo", action: "surge", every: SCRIPT_PERIOD },
...
export const REEL: ReelStep[] = [
  ...
  },
  {
    ...
    actions: [{ at: 39, type: "prompt", text: "montacarga en zona peatonal" }],
  },
  {
    at: 45,
    route: "/flujo",
    ...
    actions: [{ at: 48, type: "layer", layer: "tracks", on: true }],
  },
  {
    at: 55,
    route: "/inspeccion",
    ...
    actions: [{ at: 60, type: "prompt", text: "grieta" }],
  },
  {
    at: 66,
    route: "/documentos",
    ...
    actions: [{ at: 70, type: "prompt", text: "cantidad" }],
  },
  {
    at: 77,
    route: "/arena",
